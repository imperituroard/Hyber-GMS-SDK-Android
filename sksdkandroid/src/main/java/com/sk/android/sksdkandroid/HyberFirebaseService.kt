...
import com.sk.android.sksdkandroid.core.HyberPublicParams
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.data.size > 0) {
            try {
                ...
                println("delivery report success: messid ${remoteMessage.messageId.toString()}, fbtoken: ${HyberParameters.firebase_registration_token}, sktoken: ${ HyberParameters.hyber_registration_token}")
            }
            catch (e: Exception) {
                println("failed")
            }

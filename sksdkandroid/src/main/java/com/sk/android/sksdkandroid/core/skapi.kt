...
internal class HyberApi() {
    ...
    private fun hash(sss: String): String {
        try {
            ...
            Log.d(TAG, "Result: OK, Function: hash, Class: SkApi, input: $sss, output: $resp")
            return resp
        } catch (e: Exception) {
            Log.d(TAG, "Result: FAILED, Function: hash, Class: SkApi, input: $sss, output: failed")
            return "failed"
        }
    }
    ...
    fun hyber_device_register(
        ...
        val thread_net_f1 = Thread(Runnable {
            try {
                ...
                Log.d(
                    TAG,
                    "Result: Start step2, Function: sk_device_register, Class: SkApi, message: $message"
                );
                ...
                with(urlc as HttpsURLConnection) {
                    ...
                    Log.d(
                        TAG,
                        "Result: Finished step3, Function: sk_device_register, Class: SkApi, Response Code : ${responseCode.toString()}"
                    )
                    ...
                    if (responseCode==200) {
                        ...
                        BufferedReader(InputStreamReader(inputStream)).use {
                            ...
                            Log.d(
                                TAG,
                                "Result: Finished step4, Function: sk_device_register, Class: SkApi, Response : ${response.toString()}"
                            )
                ...
                Log.d(
                    TAG,
                    "Result: Failed step5, Function: sk_device_register, Class: SkApi, exception: ${e.stackTrace.toString()}"
                )
                function_net_answer = answ_form.register_procedure_answer2(
                    "705",
                    "unknown",
    ...
    fun hyber_device_revoke(
        ...
        val thread_net_f2 = Thread(Runnable {
            ...
            try {
                ...
                Log.d(
                    TAG,
                    "Result: Start step1, Function: sk_device_revoke, Class: SkApi, dev_list: $dev_list, X_Hyber_Session_Id: $X_Hyber_Session_Id, X_Hyber_Auth_Token: $X_Hyber_Auth_Token"
                )
                ...
                Log.d(
                    TAG,
                    "Result: Start step2, Function: sk_device_revoke, Class: SkApi, message2: $message2"
                )
...
try{
            ...
            Log.d(
                TAG,
                "\nSent 'GET' request to sk_get_device_all with : X_Hyber_Session_Id : $X_Hyber_Session_Id; X_Hyber_Auth_Token : $X_Hyber_Auth_Token; period_in_seconds : ${period_in_seconds.toString()}"
            );
    ...
    //final_answer = SkFunAnswerGeneral(700, "Failed", "Rest Api thread exception", "{}")
}
            ...
            try {
                ...
                with(mURL2.openConnection() as HttpsURLConnection) {
                    ...
                    inputStream.bufferedReader().use {
                        ...
                        Log.d(
                            TAG,
                            "Result: Finish step2, Function: sk_get_device_all, Class: SkApi, function_net_answer4: $function_net_answer4"
                        )
                    }
                }
            } catch (e: Exception) {
                Log.d(
                    TAG,
                    "Result: Failed step3, Function: sk_get_device_all, Class: SkApi, exception: $e"
                )
...
try{
    ...
    fun sk_message_callback(
        ...
        val thread_net_f6 = Thread(Runnable {
            ...
            //val stringBuilder = StringBuilder("{\"name\":\"Cedric Beust\", \"age\":23}")
            //val message = "{\"name\":\"Cedric Beust\", \"age\":23}"
            val message2 = "{\"messageId\": \"$message_id\", \"answer\": \"$sk_answer\"}"

            Log.d(TAG, "Body message to sk : $message2");
